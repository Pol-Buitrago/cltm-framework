...
SBATCH_SCRIPT="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/asr/ft_asr_matrix.sh"

# Directorio que contiene los .train.tsv (leer los model_id desde aqui)
TSV_DIR="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/data/processed/cv-22.0/cv-corpus-22.0-2025-06-20__asr/02_subsets_balanced_N/tsv"
...
RESULTS_CSV="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/outputs/matrices/asr_matrix/seeds/gender_matrix_single.csv"
