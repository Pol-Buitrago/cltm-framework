...
Llama a sv_speechLLM.train_and_eval(...) con los argumentos apropiados y
...
# Asegúrate que el path a sv_speechLLM.py es accesible (modifica si es necesario)
# Si sv_speechLLM.py está en el mismo directorio que este script basta.
...
def main():
    ...
    try:
        sv = importlib.import_module("sv_speechLLM")
    except Exception as e:
        print("ERROR: no se pudo importar sv_speechLLM. Asegúrate que sv_speechLLM.py está en PYTHONPATH.", file=sys.stderr)
        raise
