...
SID_SUBMIT="${ROOT}/src/HuBERT/speaker-no-validation/identification/submit_slurm.sh"
SV_SCRIPT="${ROOT}/src/HuBERT/speaker-no-validation/verification/sv_from_sid2.py"
...
SID_OUTPUT_ROOT="${ROOT}/src/HuBERT/speaker-no-validation/verification/outputs/single/speaker_id/${MODEL_SLUG}"
...
SV_OUT_DIR="${ROOT}/src/HuBERT/speaker-no-validation/verification/outputs/embeddings_verif/${LANG}/${TIMESTAMP}"
mkdir -p "${SV_OUT_DIR}"
