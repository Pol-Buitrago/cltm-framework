...
SBATCH_SCRIPT="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/asr/ft_asr_matrix2.sh"

# Directorio que contiene los .train.tsv (leer los model_id desde aqui)
TSV_DIR="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/data/processed/cv-22.0/cv-corpus-22.0-2025-06-20__asr/02_subsets_balanced_2N/tsv"
...
HF_CACHE_ROOT="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/hf_cache/2N"
#HF_CACHE_ROOT=""

DRY_RUN="${DRY_RUN:-false}"

# CSV de resultados (nuevo formato que usas ahora)
RESULTS_CSV="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/outputs/matrices/asr_matrix/seeds/gender_matrix_dual.csv"
