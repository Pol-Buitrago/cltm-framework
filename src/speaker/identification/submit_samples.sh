...
DATA_DIR="${DATA_DIR:-${DATA_ROOT}${TASK}_verif/02_filtered_cv_speaker/tsv}"
...
CSV_PATH="/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/outputs/speaker/${LANGS_STR}.f1_by_samples_${SEED}.csv"
