...
Llama a sv_ECAPA.train_and_eval(...) con los argumentos apropiados y
...
# Asegúrate que el path a sv_ECAPA.py es accesible (modifica si es necesario)
# Si sv_ECAPA.py está en el mismo directorio que este script basta.
...
def main():
    ...
    try:
        sv = importlib.import_module("sv_ECAPA")
    except Exception as e:
        print("ERROR: no se pudo importar sv_ECAPA. Asegúrate que sv_ECAPA.py está en PYTHONPATH.", file=sys.stderr)
        raise
