...
#SBATCH --job-name=ECAPA_train
#SBATCH --output=/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/ECAPA/logs/ECAPA_train_%j.log
#SBATCH --error=/gpfs/projects/bsc88/speech/mm_s2st/repos/paraling_speech/src/ECAPA/logs/ECAPA_train_%j.err
